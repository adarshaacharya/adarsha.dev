...
export function YoutubeIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" {...props}>
      <path d="M10.5 15.75V8.25l6.75 3.75-6.75 3.75ZM22.5 12c0 1.5-.2 2.9-.6 4.2-.4 1.3-1 2.4-1.8 3.4-.8.9-1.7 1.5-2.8 1.8-1 .4-2 .6-3.2.6H9c-1.2 0-2.2-.2-3.2-.6-.9-.3-1.7-.9-2.5-1.8-.8-.9-1.4-2-1.8-3.4C1.7 14.9 1.5 13.5 1.5 12s.2-2.9 .6-4.2c.4-1 .9-2 .8-3 .4-.9 .9-1.7 1.7-2 .8-.3 1.7-.5 2.7-.5h11c1 0 2 .2 3 .5 .9 .3 1.6 .9 2 .8 .3 .8 .5 1.7 .5 2 .4 .9 .8 1.7 1 2 .4 1 .6 2 .6 3z" />
    </svg>
  );
}
