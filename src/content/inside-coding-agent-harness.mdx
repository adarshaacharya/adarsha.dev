...
<Image
  src={"/_static/blogs/coding-agent-harness/diagram-harness.png"}
  width={450}
  height={450}
  alt="Coding agent harness architecture — data flow from user input through intent router, LLM loop, tool executor, permission policy, OS sandbox, compaction, and SQLite persistence"
/>
...
<Image
  src={"/_static/blogs/coding-agent-harness/diagram-sandbox.png"}
  width={1280}
  height={720}
  alt="Coding agent sandbox — permission policy at the app layer and OS sandbox at the kernel layer operating independently"
/>
...
<Image
  src={"/_static/blogs/coding-agent-harness/diagram-memory.png"}
  width={450}
  height={450}
  alt="Coding agent memory layers — from volatile message array through compaction artifact to persistent SQLite and permanent project files"
/>
