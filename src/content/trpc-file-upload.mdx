---
title: "Upload Files and Images to S3 with tRPC and Next.js: A Step-by-Step Guide"
type: Blog
...
Also keep on eyes on these GitHub issues:
- [Support for multipart form data](https://github.com/trpc/trpc/discussions/658)